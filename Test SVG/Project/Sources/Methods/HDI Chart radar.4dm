...
$chart.text("Employee Skills Assessment").position(250; 100).fontSize(16).fontStyle(Bold:K14:2).fillColor("#333")
...
$chart.text("Product Feature Comparison").position(750; 100).fontSize(16).fontStyle(Bold:K14:2).fillColor("#333")
