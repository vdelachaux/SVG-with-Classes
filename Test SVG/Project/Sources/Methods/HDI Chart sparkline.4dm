...
$chart.sparkline("spark_sales"; 50; 130; 300; 60; {data: $data1; color: "#2196F3"; fill: True:C214})

$chart.text("Revenue").position(450; 110).fontSize(18).fontStyle(Bold:K14:2).fillColor("#333")
$chart.sparkline("spark_revenue"; 450; 130; 300; 60; {data: $data2; color: "#4CAF50"; fill: True:C214})

// Row 2: Traffic & Errors
$chart.text("Traffic").position(50; 260).fontSize(18).fontStyle(Bold:K14:2).fillColor("#333")
$chart.sparkline("spark_traffic"; 50; 280; 300; 60; {data: $data3; color: "#FF9800"; fill: True:C214})

$chart.text("Users").position(450; 260).fontSize(18).fontStyle(Bold:K14:2).fillColor("#333")
$chart.sparkline("spark_users"; 450; 280; 300; 60; {data: $data4; color: "#E91E63"; fill: True:C214})
